...
public class Course2 extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback {
        ...
        TMapPoint Endpoint = new TMapPoint(35.8575153, 127.1429339);
        ...
        public void onLocationChange(Location location) {
                ...
                if(startA<100)
                        Toast.makeText(Course2.this, "출발지에 근접하였습니다.", Toast.LENGTH_SHORT).show();
                ...
                if(endA<100)
                        Toast.makeText(Course2.this, "도착지에 근접하였습니다.", Toast.LENGTH_SHORT).show();
        }
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                builder.setTitle("코스안내")
                        .setMessage("선택하신 코스는 약 5.17km 입니다.\n주요 경유지는\n◎전주덕진공원\n◎전북대학교\n◎전주동물원")
                ...
                RelativeLayout relativeLayout = findViewById(R.id.course2);
        ...
        tmapview.setIcon(bike);
                tmapview.setCenterPoint(127.132227, 35.849563);
                tmapview.setLocationPoint(127.132227, 35.849563);
                ...
                tmapgps = new TMapGpsManager(Course2.this);
                ...
                new Thread() {
                        public void run() {
                                ...
                                TMapPoint midpoint2 = new TMapPoint(35.839147, 127.119247); //백제교
                                TMapPoint midpoint3 = new TMapPoint(35.847423, 127.121353); //백제교
                                TMapPoint midpoint4 = new TMapPoint(35.849997, 127.128112); //백제교
                                TMapPoint midpoint5 = new TMapPoint(35.8575153, 127.1429339); //백제교
                                ...
                                try {
                                        ...
                                        polyline1.setLineColor(Color.parseColor("#027FFD"));
                                        polyline1.setOutLineColor(Color.parseColor("#027FFD"));
                                        ...
                                        polyline2.setLineColor(Color.parseColor("#027FFD"));
                                        polyline2.setOutLineColor(Color.parseColor("#027FFD"));
                                        ...
                                        polyline3.setLineColor(Color.parseColor("#027FFD"));
                                        polyline3.setOutLineColor(Color.parseColor("#027FFD"));
                                        ...
                                        polyline4.setLineColor(Color.parseColor("#027FFD"));
                                        polyline4.setOutLineColor(Color.parseColor("#027FFD"));
                                        ...
                                        polyline5.setLineColor(Color.parseColor("#027FFD"));
                                        polyline5.setOutLineColor(Color.parseColor("#027FFD"));
