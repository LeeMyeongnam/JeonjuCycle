...
public class Course4 extends AppCompatActivity implements TMapGpsManager.onLocationChangedCallback{
    ...
    TMapPoint Startpoint = new TMapPoint(35.815462, 127.149131);
    TMapPoint Endpoint = new TMapPoint(35.800347, 127.154474);
    ...
    public void onLocationChange(Location location) {
        ...
        if(startA<100)
            Toast.makeText(Course4.this, "출발지에 근접하였습니다.", Toast.LENGTH_SHORT).show();
        ...
        if(endA<100)
            Toast.makeText(Course4.this, "도착지에 근접하였습니다.", Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setTitle("코스안내")
                .setMessage("선택하신 코스는 약 5.74km 입니다.\n주요 경유지는\n◎경기전\n◎남부시장\n◎한벽당\n◎전주향교\n◎치명자산성지\n◎남고산성")
        ...
        RelativeLayout relativeLayout = findViewById(R.id.course4);
        ...
        tmapview.setCenterPoint(127.155801, 35.808472);
        tmapview.setLocationPoint(127.155801, 35.808472);
        ...
        tmapgps = new TMapGpsManager(Course4.this);
        ...
        new Thread() {
            public void run() {
                ...
                TMapPoint startpoint1 = new TMapPoint(35.815462, 127.149131); //경기전
                TMapPoint midpoint1 = new TMapPoint(35.815063, 127.154070); //한백당
                TMapPoint midpoint2 = new TMapPoint(35.816636, 127.155634); //오목대 이목대
                TMapPoint midpoint3 = new TMapPoint(35.812675, 127.157236); //전주향교
                TMapPoint midpoint4 = new TMapPoint(35.807070, 127.166281); //치명자산성지
                TMapPoint midpoint5 = new TMapPoint(35.800814, 127.157044); //남고산성
                ...
                try {
                    ...
                    polyline1.setLineColor(Color.parseColor("#FAEA10"));
                    polyline1.setOutLineColor(Color.parseColor("#FAEA10"));
                    ...
                    polyline2.setLineColor(Color.parseColor("#FAEA10"));
                    polyline2.setOutLineColor(Color.parseColor("#FAEA10"));
                    ...
                    polyline3.setLineColor(Color.parseColor("#FAEA10"));
                    polyline3.setOutLineColor(Color.parseColor("#FAEA10"));
                    ...
                    polyline4.setLineColor(Color.parseColor("#FAEA10"));
                    polyline4.setOutLineColor(Color.parseColor("#FAEA10"));
                    ...
                    polyline5.setLineColor(Color.parseColor("#FAEA10"));
                    polyline5.setOutLineColor(Color.parseColor("#FAEA10"));
